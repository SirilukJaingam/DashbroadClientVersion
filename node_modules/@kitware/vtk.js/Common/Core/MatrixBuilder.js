...
import { areMatricesEqual } from "./Math.js";
import { glMatrix, mat4, vec3 } from "gl-matrix";
//#region Sources/Common/Core/MatrixBuilder/index.js
var NoOp = (v) => v;
var EPSILON = 1e-6;
var Transform = class {
	...
	rotateFromDirections(originDirection, targetDirection) {
		...
		if (vec3.length(this.tmp) < EPSILON) {
			...
			if (vec3.length(this.tmp) < EPSILON) vec3.cross(this.tmp, [
				0,
				1,
				0
			], originDirection);
	...
	apply(typedArray, offset = 0, nbIterations = -1) {
		if (areMatricesEqual(IDENTITY, this.matrix)) return this;
	...
	setMatrix(mat4x4) {
		if (!!mat4x4 && mat4x4.length === 16) mat4.copy(this.matrix, mat4x4);
		return this;
	}
};
...
var MatrixBuilder_default = {
	buildFromDegree,
	buildFromRadian
};
//#endregion
export { MatrixBuilder_default as default };
