...
//#region Sources/Common/Core/StringArray/index.js
function vtkStringArray(publicAPI, model) {
	...
	publicAPI.getName = () => {
		if (!model.name) publicAPI.setName(`vtkStringArray${publicAPI.getMTime()}`);
		return model.name;
	};
...
var newInstance = macros_default.newInstance(extend, "vtkStringArray");
var StringArray_default = {
	newInstance,
	extend
};
//#endregion
export { StringArray_default as default, extend, newInstance };
