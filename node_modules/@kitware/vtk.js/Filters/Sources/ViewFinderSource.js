...
//#region Sources/Filters/Sources/ViewFinderSource/index.js
function vtkViewFinderSource(publicAPI, model) {
	publicAPI.requestData = (inData, outData) => {
		const dataset = outData[0]?.initialize() || PolyData_default.newInstance();
		const points = macros_default.newTypedArray(model.pointType, 48);
		...
		MatrixBuilder_default.buildFromRadian().translate(...model.center).rotateFromDirections([
			...
			0,
			0
		], model.orientation).apply(points);
...
function extend(publicAPI, model, initialValues = {}) {
	...
	macros_default.setGetArray(publicAPI, model, ["center", "orientation"], 3);
...
var ViewFinderSource_default = {
	newInstance,
	extend
};
//#endregion
export { ViewFinderSource_default as default, extend, newInstance };

//# sourceMappingURL=ViewFinderSource.js.map