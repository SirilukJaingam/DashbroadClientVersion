...
import { vtkInterpolationMathClamp, vtkInterpolationMathFloor, vtkInterpolationMathMirror, vtkInterpolationMathRound, vtkInterpolationMathWrap, vtkInterpolationWeights } from "./AbstractImageInterpolator/InterpolationInfo.js";
import AbstractImageInterpolator_default from "./AbstractImageInterpolator.js";
...
var DEFAULT_VALUES = { interpolationMode: InterpolationMode.NEAREST };
function extend(publicAPI, model, initialValues = {}) {
	Object.assign(model, DEFAULT_VALUES, initialValues);
	AbstractImageInterpolator_default.extend(publicAPI, model, initialValues);
	macros_default.setGet(publicAPI, model, ["interpolationMode"]);
	vtkImageInterpolator(publicAPI, model);
}
var newInstance = macros_default.newInstance(extend, "vtkImageInterpolator");
var ImageInterpolator_default = {
	newInstance,
	extend
};
//#endregion
export { ImageInterpolator_default as default, extend, newInstance };
