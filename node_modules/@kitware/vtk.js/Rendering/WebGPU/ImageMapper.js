...
function vtkWebGPUImageMapper(publicAPI, model) {
	...
	publicAPI.replaceShaderPosition = (hash, pipeline, vertexInput) => {
		...
		lines.push("pos = rendererUBO.SCPCMatrix * pos;", "pos.z = clamp(pos.z - 0.000016 * mapperUBO.CoincidentOffset * pos.w, 0.0, pos.w);", "output.tcoordVS = tcoord;", "output.vertexSC = pos;", "output.Position = rendererUBO.SCPCMatrix * pos;");
