...
import { add, cross, dot, subtract } from "../Core/Math.js";
...
function intersectWithPlane(plane1Origin, plane1Normal, plane2Origin, plane2Normal) {
	...
	if (absCross[0] + absCross[1] + absCross[2] < PLANE_TOLERANCE) {
		...
		if (dot(plane1Normal, v) === 0) outObj.error = COINCIDE;
...
function extend(publicAPI, model, initialValues = {}) {
	...
	macros_default.setGetArray(publicAPI, model, ["normal", "origin"], 3);
	vtkPlane(publicAPI, model);
}
var newInstance = macros_default.newInstance(extend, "vtkPlane");
var Plane_default = {
	newInstance,
	extend,
	...STATIC
...
//#endregion
export { STATIC, Plane_default as default, extend, newInstance, vtkPlane };
