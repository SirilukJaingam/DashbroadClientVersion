...
//#region Sources/Widgets/Core/StateBuilder/directionMixin.js
function vtkDirectionMixin(publicAPI, model) {
	const transform = model.angleUnit === "degree" ? MatrixBuilder_default.buildFromDegree() : MatrixBuilder_default.buildFromRadian();
...
function extend(publicAPI, model, initialValues = {}) {
	...
	macros_default.setGetArray(publicAPI, model, ["direction"], 3);
	vtkDirectionMixin(publicAPI, model);
}
var directionMixin_default = { extend };
//#endregion
export { directionMixin_default as default, extend };

//# sourceMappingURL=directionMixin.js.map