...
function vtkSphereSource(publicAPI, model) {
	...
	publicAPI.requestData = (inData, outData) => {
		...
		dataset = dataset?.initialize() || PolyData_default.newInstance();
		let numPoles = 0;
		...
		let pointIdx = 0;
		let points = macros_default.newTypedArray(pointDataType, numPts * 3);
...
var newInstance = macros_default.newInstance(extend, "vtkSphereSource");
var SphereSource_default = {
	newInstance,
	extend
};
//#endregion
export { SphereSource_default as default, extend, newInstance };
